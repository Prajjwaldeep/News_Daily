...
public class SportsFragment extends Fragment {
    ...
    Adapter adapter;
    String country="in";
    private RecyclerView recyclerViewoofsports;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewoofsports=v.findViewById(R.id. recyclerviewofsports);
        modelClassArrayList=new ArrayList<>();
        recyclerViewoofsports.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new Adapter(getActivity(), modelClassArrayList);
        recyclerViewoofsports.setAdapter(adapter);
