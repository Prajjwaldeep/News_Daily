...
public class HomeFragment extends Fragment {
    ...
    Adapter adapter;
    String country="in";
    private RecyclerView recyclerViewoofhome;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewoofhome=v.findViewById(R.id. recyclerviewofhome);
        modelClassArrayList=new ArrayList<>();
        recyclerViewoofhome.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new Adapter(getActivity(), modelClassArrayList);
        recyclerViewoofhome.setAdapter(adapter);
