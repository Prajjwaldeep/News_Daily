...
public class HealthFragment extends Fragment {
    ...
    Adapter adapter;
    String country="in";
    private RecyclerView recyclerViewoofhealth;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewoofhealth=v.findViewById(R.id. recyclerviewofhealth);
        modelClassArrayList=new ArrayList<>();
        recyclerViewoofhealth.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new Adapter(getActivity(), modelClassArrayList);
        recyclerViewoofhealth.setAdapter(adapter);
