...
public class EntertainmentFragment extends Fragment {
    ...
    Adapter adapter;
    String country="in";
    private RecyclerView recyclerViewoofentertainment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewoofentertainment=v.findViewById(R.id. recyclerviewofentertainment);
        modelClassArrayList=new ArrayList<>();
        recyclerViewoofentertainment.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new Adapter(getActivity(), modelClassArrayList);
        recyclerViewoofentertainment.setAdapter(adapter);
