...
public class TechnologyFragment extends Fragment {
    ...
    Adapter adapter;
    String country="in";
    private RecyclerView recyclerViewooftechnology;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewooftechnology=v.findViewById(R.id. recyclerviewoftechnology);
        modelClassArrayList=new ArrayList<>();
        recyclerViewooftechnology.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new Adapter(getActivity(), modelClassArrayList);
        recyclerViewooftechnology.setAdapter(adapter);
